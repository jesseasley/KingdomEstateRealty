...
%>
                  	<form method=post name="frm" action="list.asp">
...
%>
	                  		...
	                  		<tr>
	                  			<td colspan=3> <span class="sectionheading" >
									Even if you've just started thinking about selling, it's wise to find out
									about the current market trends, get an analysis of your home done and talk
									about what your options are.<br><br>Providing the information below
									will ensure a quick follow-up to begin discussing your plans and needs.
</span><br><br><br>
	                  			</td>
							</tr>
	                  		<tr>
...
%>
	                  	<table cellpadding=0 cellspacing=0 border=0 width="540">
	                  		...
	                  		<tr>
	                  			...
	                  			Someone will be contacting you shortly.<br><br>
