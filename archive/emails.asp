...
%>
                  	<form method=post name=frm action="emails.asp">
...
%>
	                  		<tr>
	                  			...
	                  			<td colspan=2 height="152">
	                  				<span class="sectionheading">Email Opt-In</span><br><br>
									<span class="text">
										This section allows you to opt-in to the email distribution list.  
										This is a wise choice because the 
										information included 
										in the distributions can help you stay 
										up-to-date with current events and trends in 
										the housing and mortgage industries.&nbsp; 
										Please fill in the required information 
										below. Once your selection
										has been made, press the Save button to save your changes.
										<br><br><br>
									</span>
	                  			</td>
							</tr>
                  	...
                  	<form method=post name="frm2" action="emails.asp">
	                  	<table cellpadding=0 cellspacing=0 border=0 width="100%">
	                  		<tr>
	                  			<td width=20>&nbsp;</td>
	                  			<td colspan=2>
	                  				<span class="sectionheading">Email Opt-Out</span>
	                  				<br><br>
	                  				<span class="text">
										This section allows you to opt-out of the email distribution list.  
										Please fill in the required information 
										below.. Once your selection
										has been made, press the Save button to save your changes.
										<br><br><br>
	...
	elseif request.form("SubmitType") = "OptOut" then
		...
		if rs.EOF then
			sql = "insert into OptInOut (Email, SystemName, OptionInOut) values ('" & replace(request.form("txtOutEmail"), "'", "''") & "', " & _
																			...
																			"'Out')"
			cn.Execute(sql)
			SendEmail "emailoptout", _
					  "", _
					  "", _
					  "", _
					  request.form("txtOutEmail")
			SendEmail "EmailOptOutCustomerResponse", _
					  "", _
					  "", _
					  "", _
					  request.form("txtOutEmail")
...
%>
	                  	<table cellpadding=0 cellspacing=0 border=0 width="540">
	                  		...
	                  		<tr>
	                  			...
	                  			Please click <a class="sectionheading" href="default.asp">>>here<<</a> to return to the main page.</span></td>
	                  		</tr>
	                  	</table>
<%
end if
