...
for ($j = 0;$j < $k;$j++){
echo "processing outter for loop -> j = " . $j . "<br>";
    //build URL to call
    if ($featured > ""){
        ...
        if ($mls > ""){
	        ...
	        $url .= "&c_location=" . $city . "&c_itype=" . $type . "&minprice=" . $minimum_price . "&minbedroom=";
            $url .= $minimum_bedrooms . "&minbathroom=" . $minimum_bathrooms . "";
...
echo $url . "<br>";
    ...
    for ($i = 0; $i < $l; $i++) {
echo "processing inner for loop -> i = " . $i . "<br>";

echo "<br>*********************new item*************************<br>";

        if (strlen($result) > 20){
echo "page data returned, so lets proceed <br>";
if (strpos($result, "listing_content_box_wrapper", $pos))
    $listing_start = strpos($result, "listing_content_box_wrapper", $pos);
else
    $listing_start = "no record found";
    
echo "found record at location = " . $listing_start . "<br>";
...
echo "end of record at location = " . $listing_end . "<br>";
            $listing = substr($result, $pos, $listing_end - $pos);
echo "length of listing = " . strlen($listing) . "<br>";
...
echo "!> 20 <br>";
	    ...
	    if (strlen($listing) > 0){
echo "getting data from listing <br>";
            //get the address
...
echo "address: " . $addr . "<br>";
            ...
            if (($i == 0) && ($j == 0)){
echo "setting item as active<br>";
                $html .= "<div class='item active'>";
            }
            else{
echo "item is not active<br>";
                $html .= "<div class='item'>";
            }
                    $html .= "<div>";
                        $html .= "<div class='row'>";
